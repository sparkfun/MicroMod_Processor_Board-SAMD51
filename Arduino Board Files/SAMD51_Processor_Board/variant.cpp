...
const PinDescription g_APinDescription[]=
{
  ...
  // 25,26
  // I2C pins (SDA/SCL)
  { PORTA, 16, PIO_SERCOM, PIN_ATTR_PWM_F, No_ADC_Channel, TCC1_CH0, TC2_CH0, EXTERNAL_INT_0 }, // SDA
  { PORTA, 17, PIO_SERCOM, PIN_ATTR_PWM_G, No_ADC_Channel, TCC0_CH5, TC2_CH1, EXTERNAL_INT_1 }, // SCL

  // 27,28
  // I2C1 (SDA1/SCL1) 
  { PORTA, 12, PIO_SERCOM, PIN_ATTR_PWM_F, No_ADC_Channel, TCC1_CH2, TC2_CH0, EXTERNAL_INT_12 },   // SDA1
  { PORTA, 13, PIO_SERCOM, PIN_ATTR_PWM_G, No_ADC_Channel, TCC1_CH3, TC2_CH1, EXTERNAL_INT_13 }, // SCL2

  // 29..32
  // I2S (WS,SDO,SDI,CLK)
  { PORTA, 20, PIO_SERCOM_ALT, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_4 },  // WS
